...
class ShapeChooserPanel extends JPanel implements ActionListener {
	...
	public ShapeChooserPanel(PaintPanel paintPanel) {	
		...
		String[] buttonLabels = {RenderableShape.LABEL_CIRCLE, RenderableShape.LABEL_RECTANGLE, RenderableShape.LABEL_SQUARE, RenderableShape.LABEL_SQUIGGLE, RenderableShape.LABEL_POLYLINE, RenderableShape.LABEL_OVAL};
